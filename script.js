...
const projects = [
  {
    ...
    title: "MoodAktif",
    description:
      "Android Studio ve Java kullanarak geliştirdiğim yapay zekâ destekli mobil uygulama. Kullanıcıların günlük ruh hallerini takip eder ve kişiye özel öneriler sunar.",
    image: "moodaktif.jpg",
  ...
  },
  {
    ...
    description:
      "Film yorumlarının olumlu ya da olumsuz olduğunu belirlemek için Naive Bayes, Lojistik Regresyon, SVM ve Random Forest yöntemlerini kullandım.",
    image: "dogal-dil-isleme.jpg",
  ...
  },
  {
    ...
    description:
      "ASP.NET ve SQL Server kullanarak geliştirdiğim otopark yönetim sistemi. Kullanıcılar otopark yerlerini rezerve edebilir ve yönetebilir.",
    image: "e-park.jpg",
  ...
  },
  {
    ...
    description:
      "Bir grup Üniversite Öğrencilerine ait bir veri kümesini kullanarak onların demografik özellikleri üzerinden depresyon, anksiyete ve panik atak gibi zihinsel sağlık durumlarını incelemek ve bunları sınıflandırmaya yönelik bir model geliştirmektir.",
    image: "ruh-sagligi.jpg",
...
function renderProjects() {
  ...
  for (let i = 0; i < visibleProjects; i++) {
    ...
    projectCard.className = project.isGithubCard
      ? "project-card github-card"
      : "project-card";

    const iconClass = project.isGithubCard
      ? "icon-circle github-icon"
      : "icon-circle";
    ...
    projectCard.innerHTML = `
      ...
      <div class="project-actions">
        <button class="btn btn-color-2" onclick="location.href='${
          project.link
        }'">${project.isGithubCard ? "GitHub" : "Projeye Git"}</button>
      </div>
    `;
